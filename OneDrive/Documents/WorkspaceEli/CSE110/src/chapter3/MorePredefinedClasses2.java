...
/* 
Program Name : MorePredefinedClasses2Solution.java
Author : P Baker
Date Written : 
...
public class MorePredefinedClasses2 {
	  	...
	  	public static void main(String[] args)
	  	{
			...
			/*
			 * Example: Using the Math class. Ch 3.5 This class is automatically
			 * available. No import statement is needed. This is a unique class, all
			 * methods are static, and we do not create Math objects. We just call
			 * the methods with the class name.
			 * 
			 * Example: Take the square root of a number (must be pos) Example: Show
			...
			System.out.println("The square root of " + num2 + ": " + dFmt.format(num3));
	
			// PI is a constant in the Math class
			System.out.println("The value of PI : " + Math.PI);
			System.out.println("the value of PI (formatted): " + dFmt.format(Math.PI));
...
The square root of 7.892: 2.809270367906941
The square root of 7.892: 2.81
The value of PI : 3.141592653589793
the value of PI (formatted): 3.14
The price in currency format is: $43.24
