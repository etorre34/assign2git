package src.com.csc205.activities.activity2.part1;
...
public class Card
    ...
    /**
     * Implemented only because it's a good idea to do so when implementing equals (used with hash type collections, HashMap, etc...)
     *
     * @return
     */
