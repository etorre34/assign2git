package src.com.csc205.activities.activity2.part3;
...
public class Card implements Comparable<Card> {
    ...
    /**
     * Implemented only because it's a good idea to do so when implementing equals (helps with HashMap usage, etc...)
     *
     * @return
     */
    @Override
