...
import src.com.csc205.projects.project9.jsjf.ArrayUnorderedList;
...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
    ...
    private int height(BinaryTreeNode<T> node) 
    {
        ...
        // if the node is null return 0, otherwise return 1 plus the
        ...
        {
        	ret = Math.max(
        			1 + height(node.getLeft()),
        			1 + height(node.getRight())
        			);
        }
        return ret;
    }
