...
import src.com.csc205.projects.project8.jsjf.exceptions.ElementNotFoundException;
import src.com.csc205.projects.project8.jsjf.exceptions.EmptyCollectionException;
import src.com.csc205.projects.project8.jsjf.exceptions.NonComparableElementException;
                                        ...
                                        implements BinarySearchTreeADT<T>
{
    ...
    public LinkedBinarySearchTree(BinaryTreeNode<T> node) {
		
    	super(node);
    	
    	if (!(node.element instanceof Comparable)) {
    		throw new NonComparableElementException("LinkedBinarySearchTree");
    	}
	}
    ...
    public LinkedBinarySearchTree<T> getLeft()
    {
    	...
    	return new LinkedBinarySearchTree<T>(root.left);
    }
